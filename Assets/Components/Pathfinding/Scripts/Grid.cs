...
namespace Pathfinding
{
    ...
    public class Grid : MonoBehaviour,IMap
    {
        public class GridNode: Node
        {
            ...
            public GridNode(bool _walkable, Vector3 _worldPos, int _gridX, int _gridY, int _penalty):base(_walkable,_worldPos,_penalty)
            {
                this.gridX = _gridX;
                this.gridY = _gridY;
            }
